...
import FormInput from './formsInput/WorkOrderSearchInput';
import Btn from '../components/generalButton/ButtonClickHandler';
...
const WorkOrderSearchForm = (
  ...
  return (
    <div className="form-container" data-tid="container">
      <div>
